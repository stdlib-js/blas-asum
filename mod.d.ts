...
interface Unary {
	...
	*/
	...
	/**
	* Computes the sum of absolute values (L1 norm) along one or more ndarray dimensions and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
